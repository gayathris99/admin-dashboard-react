  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <TooltipComponent content="Profile" position="BottomCenter">
        <div className='flex items-center cursor-pointer p-1 hover:bg-light-gray rounded-lg gap-2'
        onClick={() => handleClick('userProfile')}>
          <img src={avatar}
          className='rounded-full w-8 h-8'></img>
          <p>
            <span className='text-gray-400 text-14'>Hi, </span> {' '}
            <span className='font-fond ml-1 text-14 text-gray-400'>Michael</span>
          </p>
